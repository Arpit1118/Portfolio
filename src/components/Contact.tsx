      ...
      <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  { icon: Mail, label: "arpitmadhu18@gmail.com", href: "mailto:arpitmadhu18@gmail.com", color: "from-red-400 to-pink-400" },
                  { icon: Phone, label: "+4915901602186", href: "tel:+4915901602186", color: "from-green-400 to-blue-400" },
                  { icon: Github, label: "GitHub Profile", href: "https://github.com/Arpit1118", color: "from-gray-400 to-gray-600" },
                  { icon: Linkedin, label: "LinkedIn Profile", href: "https://www.linkedin.com/in/arpitmadhu18/", color: "from-blue-400 to-blue-600" }
                ].map((social, index) => (
                  <motion.a
                    key={social.label}
                    href={social.href}
        ...
        >
          <p className="text-gray-500">
            © 2026 Arpit Madhu. Engineering the future with AI.
          </p>
        </motion.div>
      </div>
    </section>
